...
def test_vertical_temp_gradient_triggers_confirmed_inversion():
    ...
    # Warm air aloft (25°C at 200m) over cold surface (18°C at ground) -> Inversion
    inv = calculate_inversion_indicator(temp_surface_c=18.0, temp_upper_c=25.0, delta_z_m=200.0)
